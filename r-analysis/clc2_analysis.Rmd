...
plots <- mapply(plot_paired_boxplot, data = dataReorg, prefix = filePrefixes, measureName = measureName, drugName = drugNames, drugColor = drugColors, suffix = "pairedboxplot_all.png")

# Plot box plots with phases 1 & 2 only
plots <- mapply(plot_paired_boxplot, data = dataPhase12, prefix = filePrefixes, measureName = measureName, drugName = drugNames, drugColor = drugColors, suffix = "pairedboxplot_phase12.png")
```
